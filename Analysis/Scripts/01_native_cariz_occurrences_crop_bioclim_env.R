...
df <- read.table("nat_range/nat_cariz_convhull.csv",
                 header=TRUE, 
                 sep=",",
                 row.names=NULL)
...
dir.create("cariz_env")

#set working directory to new folder
setwd("/home/kochj/hilo_koch_lts/biomod_inR/Tabor-thesis/cariz_env/")

# create directory for the bioclimatic variables
dir.create("bioclim")

#save env conex hull polygon in env folder
writeOGR(env, "cariz_env", layer="cariz_env", driver="ESRI Shapefile")
...
setwd("/home/kochj/hilo_koch_lts/biomod_inR/Tabor-thesis/cariz_env/bioclim/")

...
df <- read.table("nat_range/nat_mumbri_convhull.csv",
                 header=TRUE, 
                 sep=",",
                 row.names=NULL)
...
dir.create("mumbri_env")

#set working directory to new folder
setwd("/home/kochj/hilo_koch_lts/biomod_inR/Tabor-thesis/mumbri_env/")

# create directory for the bioclimatic variables
dir.create("bioclim")

#save env conex hull polygon in env folder
writeOGR(env, "mumbri_env", layer="mumbri_env", driver="ESRI Shapefile")
...
setwd("/home/kochj/hilo_koch_lts/biomod_inR/Tabor-thesis/mumbri_env/bioclim/")

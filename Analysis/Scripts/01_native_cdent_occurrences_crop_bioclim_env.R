...
df <- read.table("nat_range/nat_cdent_convhull.csv",
                 header=TRUE, 
                 sep=",",
                 row.names=NULL)
...
dir.create("cdent_env")

#set working directory to new folder
setwd("/home/kochj/hilo_koch_lts/biomod_inR/Tabor-thesis/cdent_env/")

# create directory for the bioclimatic variables
dir.create("bioclim")

#save env conex hull polygon in env folder
writeOGR(env, "cdent_env", layer="cdent_env", driver="ESRI Shapefile")
...
setwd("/home/kochj/hilo_koch_lts/biomod_inR/Tabor-thesis/cdent_env/bioclim/")

...
df <- read.table("nat_range/nat_amelli_convhull.csv",
                 header=TRUE, 
                 sep=",",
                 row.names=NULL)
...
dir.create("amelli_env")

#set working directory to new folder
setwd("/home/kochj/hilo_koch_lts/biomod_inR/Tabor-thesis/amelli_env/")

# create directory for the bioclimatic variables
dir.create("bioclim")

#save env conex hull polygon in env folder
writeOGR(env, "amelli_env", layer="amelli_env", driver="ESRI Shapefile")
...
setwd("/home/kochj/hilo_koch_lts/biomod_inR/Tabor-thesis/amelli_env/bioclim/")
